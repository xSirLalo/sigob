...
class OperGobServiceAdapter{
    ...
    public function AddSolicitud($cvpersona,$añoInicial,$añoFinal,$ubicacion,$localidad,$id,$observacion,$loteConflicto) {
        ...
        $parametros = [
            ...
            "SolicitudObservaciones"    => "PAGO CORRESPONDIENTE AL EJERCICIO FISCAL DEL AÑO ".$añoInicial."-".$añoFinal."'\n',UBICADO ".$ubicacion." ,LOCALIDAD ".$localidad." ID ".$id." ,".$observacion.", ".$loteConflicto ,
            "SolicitudPadronId"         => "0",
